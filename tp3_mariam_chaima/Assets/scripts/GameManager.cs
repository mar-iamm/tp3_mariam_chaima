...
public class GameManager : MonoBehaviour
{
    ...
    public static int savedDayScore = 0;
    ...
    void Start()
    {
        ...
        Debug.Log("Start GameManager → currentDay = " + currentDay);
    ...
    public void AddScore(int amount)
    {
        ...
        savedDayScore = dayScore;
        savedTotalScore = totalScore;

        Debug.Log("Score journée : " + dayScore);
        Debug.Log("Score total : " + totalScore);
        Debug.Log("Score journée sauvegardé : " + savedDayScore);
        Debug.Log("Score total sauvegardé : " + savedTotalScore);
    ...
    {
        Debug.Log("Continue après journée " + savedCurrentDay);
